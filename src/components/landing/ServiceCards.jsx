  ...
  return (
    ...
    >
      <div className="relative h-[480px] sm:h-[440px] overflow-hidden">
        ...
        <div className="absolute left-3 right-3 bottom-3 top-16 sm:top-20 bg-white/85 backdrop-blur-sm rounded-xl p-5 shadow-lg overflow-y-auto">
  ...
  return (
    ...
    >
      <div className="relative h-[480px] sm:h-[440px] overflow-hidden">
        ...
        <div className="absolute left-3 right-3 bottom-3 top-20 sm:top-24 bg-white/85 backdrop-blur-sm rounded-xl p-5 shadow-lg overflow-y-auto">
...
function CardGrua() {
  return (
    <motion.div
      ...
      className="group relative bg-card rounded-2xl border border-border overflow-hidden hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-1 flex flex-col h-full"
    >
      <div className="relative h-[560px] sm:h-[500px] overflow-hidden">
        <img

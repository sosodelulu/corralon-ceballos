...
function CardMateriales() {
  return (
    <motion.div
      ...
      className="group relative bg-card rounded-2xl border border-border overflow-hidden hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-1 flex flex-col"
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        ...
        <a
          ...
          className="mt-auto mt-6 inline-flex items-center justify-center w-full gap-2 bg-green-500 hover:bg-green-600 text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all duration-200"
        >

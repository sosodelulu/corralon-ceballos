        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href="https://www.instagram.com/corralonceballos.rc" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-white/5 hover:bg-accent/20 flex items-center justify-center transition-colors group" aria-label="Instagram">
                <svg className="w-4 h-4 fill-white/50 group-hover:fill-accent transition-colors" viewBox="0 0 24 24">
